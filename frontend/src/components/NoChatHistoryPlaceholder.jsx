...
const NoChatHistoryPlaceholder = ({ name }) => {
  ...
  <h3 className="text-base sm:text-lg font-medium text-slate-200 mb-3 break-words">
    Start your conversation with {name}
  </h3>

  <div className="flex flex-col space-y-2 sm:space-y-3 max-w-xs sm:max-w-md mb-5 px-2">
  ...
  <div className="flex flex-wrap gap-2 justify-center">
    <button className="px-3 py-1 text-xs sm:text-sm font-medium text-cyan-400 bg-cyan-500/10 rounded-full hover:bg-cyan-500/20 transition-colors">
      👋 Say Hello
    </button>
    <button className="px-3 py-1 text-xs sm:text-sm font-medium text-cyan-400 bg-cyan-500/10 rounded-full hover:bg-cyan-500/20 transition-colors">
      🤝 How are you?
